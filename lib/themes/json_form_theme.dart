...
abstract class JsonFormTheme {
  ...
  const JsonFormTheme({required this.headerContainerPadding,
...
class DefaultTheme extends JsonFormTheme {
  ...
  const DefaultTheme({TextStyle descriptionTextStyle = const TextStyle(
    color: neutral2,
    fontFamily: 'Avenir',
    fontSize: 12,
    ...
    BoxDecoration staticContainerDecoration = const BoxDecoration(
      ...
      const EdgeInsets.only(left: 20, right: 10, top: 14, bottom: 8),
